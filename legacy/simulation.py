...
class SimulationSection(Section):
    ...
    def __init__(self, parent_app, **params):
        ...
        model1 = SimulationCard(parent_app, latex_description=description, model_class=ShallowMoments, title="Model #1")
        model2 = SimulationCard(parent_app, latex_description=description, model_class=ShallowMoments, title="Model #2")
