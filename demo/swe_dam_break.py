# %% [markdown] zoomy={"role":"meta","title":"SWE dam break (1D)","description":"Shallow water, 50 cells."}
# # SWE dam break (1D)
# 
# Shallow water, 50 cells.

# %% [markdown] zoomy={"role":"heading","section":"model"}
# ## Model

# %% zoomy={"role":"model","class_path":"zoomy_core.model.models.SWE","init":{"dimension":1}}
